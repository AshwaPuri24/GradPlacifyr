...
const TpoDashboardHome = () => {
  ...
  const branchDistribution = useMemo(() => {
    const studentCount = new Set(applications.map((a) => a.studentEmail)).size
    return [
      { branch: 'CSE/IT', students: Math.round(studentCount * 0.36), placed: Math.round(studentCount * 0.36 * 0.52) },
      { branch: 'ECE', students: Math.round(studentCount * 0.24), placed: Math.round(studentCount * 0.24 * 0.48) },
      { branch: 'BBA', students: Math.round(studentCount * 0.22), placed: Math.round(studentCount * 0.22 * 0.45) },
      { branch: 'BCA', students: Math.round(studentCount * 0.18), placed: Math.round(studentCount * 0.18 * 0.42) },
    ]
  }, [applications])
  ...
  return (
    <DashboardLayout
      ...
      quickActions={
        <div className="workflow-cards-grid workflow-cards-5">
          <WorkflowCard
            to="/tpo/approve-jobs"
            ...
            <div className="admin-section-head">
              <div className="admin-section-title">
                ...
                <div>
                  ...
                  <p>Latest student movements and drive updates</p>
                </div>
              </div>
              <Link to="/tpo/monitor-applications" className="admin-view-all">
                View All <ChevronRight size={14} />
              </Link>
            </div>
            <div className="admin-activity-scroll">
              <ActivityTimeline items={activityItems} emptyText="No recent activity in the queue." />
            </div>
          </div>
          {/* RIGHT — Calendar */}
          ...
          <div className="admin-pending-analytics-grid">
            ...
            <section className="dashboard-section dashboard-section-pending">
              <div className="dashboard-section-head">
                ...
                <Link to="/tpo/approve-jobs" className="section-view-all">
                  View All <ChevronRight size={14} />
                </Link>
              </div>
              <div className="pending-actions-list">
                <Link to="/tpo/approve-jobs" className="pending-action-item">
                ...
                <Link to="/tpo/monitor-applications" className="pending-action-item">
                ...
                <Link to="/tpo/manage-students" className="pending-action-item">
                ...
                <Link to="/tpo/manage-companies" className="pending-action-item">
